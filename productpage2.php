...
<html lang="en">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="productimages/car11.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="productimages/car22.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="productimages/car33.png" class="d-block w-100" alt="...">
    </div>
  </div>
...
<!--carouselend-->
      ...
      <h2 style="text-decoration: underline;text-align:center;padding-bottom:35px">Welcome To NANO-tech Shop</h2>
          <!--card-->
          <div class="row">
              
             <?php
              $sql = "SELECT * FROM `products` WHERE product_id>12 and product_id<=20";
  ...
  <ul class="pagination pagination-sm">
   <li class="page-item"><a class="page-link" href="productpage1.php">1</a></li>
    <li class="page-item active" aria-current="page"><span class="page-link" href="#">2</span></li>
