...
<!--carouselend-->
      ...
      <h2 style="text-decoration: underline;text-align:center;padding-bottom:15px">Welcome To NANO-tech Shop</h2>
          <!--card-->
          <div class="row">
  ...
  <ul class="pagination pagination-sm">
    ...
    <li class="page-item"><a class="page-link" href="productpage2.php">2</a></li>
