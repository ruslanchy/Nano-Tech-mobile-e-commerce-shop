...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">
      <img src="productimages/projectlogo.png" style="width:100px;height:50px">   </a>
  ...
  <button class="btn btn-outline-success dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: antiquewhite">
      <img src="productimages/user.png">
  </button>
...
<!--carouselend-->
      ...
      <h2 style="text-decoration: underline;text-align:center;padding-bottom:15px">SPECIAL OFFERS</h2>
          <!--card-->
          <div class="row">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Special Price     <br>৳'.$price.'</p>
