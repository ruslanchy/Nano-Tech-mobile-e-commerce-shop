...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="css/teamsheet.css"> 
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <li><a class="dropdown-item" href="logout.php">Logout
      ...
      <?php
              ...
              $sql = "SELECT * FROM `teamdb` WHERE memid<=2;";
              ...
              while($row=mysqli_fetch_assoc($result)){
                   ...
                   $prof = $row['memprof'];
                   $profurl = $row['memurl'];
                  echo '<div class="col-md-6 profile text-center">
              <div class="img-box">
                <img src="'.$image.'" class="img-responsive">
                <ul>
                  <a href="'.$profurl.'"><i class="fab fa-facebook"></i></a>
